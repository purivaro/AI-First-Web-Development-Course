var e=`# 🌐 คู่มือประกอบการเรียน Session 5 — External APIs & Intro to RAG
...
|---|---|---|
| 1 | 0:00 – 0:10 | ทบทวน + เปิดประเด็น "เชื่อมเว็บกับโลกภายนอก + ใส่ AI ลงในเว็บ" |
| 2 | 0:10 – 0:30 | **API คืออะไร** + JSON พื้นฐาน |
| 3 | 0:30 – 0:55 | Workshop 1: **Weather App** ดึง API สาธารณะ |
| 4 | 0:55 – 1:20 | **LLM API** — เรียก Claude/GPT จากเว็บของเรา + Mini Chatbot |
| 5 | 1:20 – 1:30 | *พักเบรก* |
...
## 🌟 ส่วนที่ 6 — Google APIs: เครื่องมือที่ใช้บ่อยที่สุดในงานจริง
*(30 นาที)*
...
### 6.2 หมวด Google APIs ที่ควรรู้
...
### 6.3 2 รูปแบบการใช้ Google APIs
...
### 6.4 Mini Walkthrough 1: Google Maps
...
### 6.5 Mini Walkthrough 2: Google Calendar
...
### 6.6 Mini Walkthrough 3: Google Sheets เป็น "DB ง่ายๆ"
...
### 6.7 Pattern ที่เจอบ่อยในวัด/โรงเรียน
...
### 7.1 ทำไม LINE OA เหมาะกับงานคนไทย
...
### 7.2 LINE OA + Messaging API คืออะไร
...
### 7.4 สถาปัตยกรรม LINE OA + Web App
\`\`\`
...
### 7.5 Use Cases ในวัด / โรงเรียน / ศูนย์ปฏิบัติธรรม
| Use Case | กลไก |
|---|---|
...
### 7.6 LIFF — เว็บแอปของเรารันใน LINE ได้
...
### 7.7 Prompt ตัวอย่าง: สร้าง LINE Bot เบื้องต้น
