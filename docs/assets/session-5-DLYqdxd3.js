...
- ลองเมืองอื่น
- ถ้า API พัง — เปิด DevTools → Network tab → ดูว่า request ส่งถูกไหม (ใช้ Debug Workflow จาก S2)
...
5. **LLM ตอบโดยอ้างอิงจากเอกสาร** (ไม่มั่ว)

### 6.3 ทำไมไม่ใช่แค่ "แปะข้อมูลทั้งหมด" ลงใน prompt?
...
- ถ้าไม่มีคำตอบใน knowledge ให้บอก "ไม่ทราบ" แทนการมั่ว
