var e=`# 🌐 คู่มือประกอบการเรียน Session 4 — Connecting to Google & LINE APIs
*(ฉบับอ่านทำความเข้าใจด้วยตัวเองและใช้สอนได้ทันที)*

> **ระยะเวลา:** 2 ชั่วโมง 45 นาที
> **กลุ่มเป้าหมาย:** ผู้เรียนที่ผ่าน Session 1-3 มาแล้ว
...
4. **เตรียมตัวคาบหน้า (S5 - System Design):** ลองคิดดูว่ามีปัญหาในงานจริงอะไรบ้างที่อยากให้ AI ช่วยออกแบบ solution
