...
## 🧠 Session 4 — Building AI-Generated Web Apps with Real Logic

*จากหน้าเว็บ → เว็บแอพที่มีตรรกะจริง*

### 🎯 เป้าหมายคาบนี้
- เข้าใจ "logic" ของเว็บแอพ
- ใช้ AI สร้างเว็บแอพง่าย ๆ
- ปรับฟีเจอร์ด้วยการสั่ง AI

### 📖 เนื้อหา
- State คืออะไร
- การอัปเดต UI ตามข้อมูล
